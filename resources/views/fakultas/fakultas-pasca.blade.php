        ...
        <div class="container position-relative">
            <div class="row align-items-start align-items-lg-end justify-content-end flex-column flex-lg-row extra-small-screen"
                ...
                <div class="col-xxl-7 col-lg-6 col-md-10 position-relative page-title-large md-mb-10px xs-mb-5px">
                    <h1 class="text-white alt-font fw-500 ls-minus-2px mb-0">Fakultas Pascasarjana</h1>
                </div>
            ...
            <div class="container my-5">
                <div class="row justify-content-center">
                    <div class="col-md-4 text-center text-dark-gray">
                        ...
                        <span>Dekan Fakultas Pascasarjana</span>
                        <p>Nama Dekan</p>
                    </div>
                    <div class="col-md-8">
                        <p class="text-dark-gray">Selamat datang di Fakultas Pascasarjana. Kami berkomitmen
                            untuk
                        ...
                        <table class="table table-bordered text-left">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>S2 Administrasi Bisnis Konsentrasi Bisnis Digital</td>
                                    <td class="text-center"><a href="https://administrasibisnis.iwu.ac.id"
                                            target="_blank">administrasibisnis.iwu.ac.id</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-6 xs-mb-9">
                <div class="col-md-8 text-center"
                    ...
                    <h2 class="alt-font mb-5px text-dark-gray ls-minus-2px">Fakultas Pascasarjana</h2>
                </div>
            </div>
