...
<body class="overflow-x-hidden" data-mobile-nav-style="classic">
    ...
    <section
        ...
        style="background-image: url(images/IWU/3.png)">
        ...
        <div class="container position-relative">
            <div class="row align-items-start align-items-lg-end justify-content-end flex-column flex-lg-row extra-small-screen"
                ...
                <div class="col-xxl-7 col-lg-6 col-md-10 position-relative page-title-large md-mb-10px xs-mb-5px">
                    <h1 class="text-white alt-font fw-500 ls-minus-2px mb-0">Fakultas Ilmu Sosial dan Bisnis</h1>
                </div>
            ...
            <div class="container my-5">
                <div class="row justify-content-center">
                    <div class="col-md-4 text-center text-dark-gray">
                        <img src="../images/IWU/logo.png" alt="Foto Dekan" class="img-fluid mb-3">
                        <span>Dekan Fakultas Ilmu Sosial dan Bisnis</span>
                        <p>Nama Dekan</p>
                    </div>
                    <div class="col-md-8">
                        <p class="text-dark-gray">Selamat datang di Fakultas Ilmu Sosial dan Bisnis. Kami berkomitmen
                            untuk
                        ...
                        <table class="table table-bordered text-left">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-center"><a href="https://adminbisnis.iwu.ac.id"
                                            target="_blank">adminbisnis.iwu.ac.id</a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">2</td>
                                    <td>Ilmu Komunikasi</td>
                                    <td class="text-center"><a href="https://komunikasi.iwu.ac.id"
                                            target="_blank">komunikasi.iwu.ac.id</a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">3</td>
                                    <td>Politik</td>
                                    <td class="text-center"><a href="https://politik.iwu.ac.id"
                                            target="_blank">politik.iwu.ac.id</a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">4</td>
                                    <td>Hubungan Internasional</td>
                                    <td class="text-center"><a href="https://hi.iwu.ac.id"
                                            target="_blank">hi.iwu.ac.id</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-6 xs-mb-9">
                <div class="col-md-8 text-center"
                    ...
                    <h2 class="alt-font mb-5px text-dark-gray ls-minus-2px">Fakultas Ilmu Sosial dan Bisnis</h2>
                </div>
            </div>
