        ...
        <div class="container position-relative">
            <div class="row align-items-start align-items-lg-end justify-content-end flex-column flex-lg-row extra-small-screen"
                ...
                <div class="col-xxl-7 col-lg-6 col-md-10 position-relative page-title-large md-mb-10px xs-mb-5px">
                    <h1 class="text-white alt-font fw-500 ls-minus-2px mb-0">Fakultas Sains dan Teknologi</h1>
                </div>
            ...
            <div class="container my-5">
                <div class="row justify-content-center">
                    <div class="col-md-4 text-center text-dark-gray">
                        <img src="{{ asset ('images/IWU/logo.png')}}" alt="Foto Dekan" class="img-fluid mb-3">
                        <span>Dekan Fakultas Sains dan Teknologi</span>
                        <p>Nama Dekan</p>
                    </div>
                    <div class="col-md-8">
                        <p class="text-dark-gray">Selamat datang di Fakultas Sains dan Teknologi. Kami berkomitmen untuk
                            memberikan pendidikan
                            berkualitas tinggi yang mempersiapkan lulusan dengan keahlian yang diperlukan untuk
                            berkontribusi secara signifikan dalam bidang sains dan teknologi, baik di tingkat nasional
                            maupun internasional.</p>
                    </div>
                </div>
            </div>
            <div class="h-2px bg-dark-gray mb-50px"
                    ...
                    <div class="col-md-8">
                        <table class="table table-bordered text-left">
                            <thead class="bg-purple text-white">
                                <tr>
                                    <th class="text-center">No</th> <!-- Rata tengah untuk kolom No -->
                                    <th>Program Studi</th>
                                    <th class="text-center">Link Website</th>
                                    <!-- Rata tengah untuk kolom Link Website -->
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    <td class="text-center">1</td> <!-- Rata tengah untuk sel No -->
                                    <td>S1 Biologi</td>
                                    <td class="text-center"><a href="https://bio.iwu.ac.id"
                                            target="_blank">bio.iwu.ac.id</a></td>
                                    <!-- Rata tengah untuk sel Link Website -->
                                </tr>
                                <tr>
                                    <td class="text-center">2</td>
                                    <td>S1 Fisika</td>
                                    <td class="text-center"><a href="#"
                                            target="_blank">fisika.iwu.ac.id</a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">3</td>
                                    <td>S1 Kimia</td>
                                    <td class="text-center"><a href="#"
                                            target="_blank">kimia.iwu.ac.id</a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">4</td>
                                    <td>S1 Matematika</td>
                                    <td class="text-center"><a href="#"
                                            target="_blank">matematika.iwu.ac.id</a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">5</td>
                                    <td>S1 Teknik Informatika</td>
                                    <td class="text-center"><a href="#"
                                            target="_blank">informatika.iwu.ac.id</a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">6</td>
                                    <td>S1 Desain Komunikasi Visual</td>
                                    <td class="text-center"><a href="#"
                                            target="_blank">dkv.iwu.ac.id</a></td>
                                </tr>
                                <tr>
                                    <td class="text-center">7</td>
                                    <td>S1 Desain Interior</td>
                                    <td class="text-center"><a href="#"
                                            target="_blank">interior.iwu.ac.id</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="container">
            <div class="row justify-content-center mb-6 xs-mb-9">
                <div class="col-md-8 text-center"
                    ...
                    <h2 class="alt-font mb-5px text-dark-gray ls-minus-2px">Fakultas Sains dan Teknologi</h2>
                </div>
            </div>

            <div class="row justify-content-center mb-5 xs-mb-8"
                data-anime='{ "el": "childs", "translateY": [30, 0], "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'>
                <!-- start fancy text box item (Ketua Program Studi) -->
                <div class="col-12 col-md-4 mb-30px">
                    <div class="hover-box md-mb-30px">
                        <img class="w-50 mx-auto d-block" src="{{ asset('images/IWU/logo.png') }}" alt="Ketua Program Studi">
                        <div class="p-30px last-paragraph-no-margin text-center">
                            <span class="d-inline-block fs-22 alt-font">Program Studi</span>
                            <p>Nama Program Studi</p>
                            <span class="text-dark">Nama Ketua Program Studi</span>
                        </div>
                    </div>
                </div>
                ...
                <!-- end fancy text box item (Ketua Program Studi) -->
            </div>
        </div>
    </section>
    <!-- end section -->
